...
export default class WebComponentDisplay {
   ...
   ////////////////////////////////////////////////////
    ...
    loadComponentDisplay() {
        ...
        //make the container
        this.mainElement = uiutil.createElementWithClass("div","webapp_pageChild_mainClass",null);
        ...
        this.viewContainer = uiutil.createElementWithClass("div","weapp_pageChild_viewContainerClass",this.mainElement);
