import { joinUp, lift, selectParentNode, setBlockType, wrapIn } from '/prosemirror/dist/prosemirror-commands.es.js';
...
class DropdownSubmenu {
  ...
  render(view) {
    ...
    let wrap = crelt("div", {class: prefix$1 + "-submenu-wrap"}, label,
