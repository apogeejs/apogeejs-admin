...
visicomp.app.visiui.dialog.createWorksheetDialog = function(onCreateFunction) {
    ...
    line.appendChild(visicomp.visiui.createElement("div",{"className":"dialogTitle","innerHTML":"New Worksheet"}));
    ...
    var onCreate = function() {
        ...
        if(!result.success) {
            alert("There was an error adding the worksheet: " + result.msg);
            return;
        }
