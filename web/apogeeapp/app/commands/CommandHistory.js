...
apogeeapp.app.CommandHistory = class {
     ...
     * the value apogee.app.CommandHistory.NO_COMMAND. */
    getNextUndoDesc() {
     ...
     * is one or an empty string. If there is no undo command, this method will return
     * the value apogee.app.CommandHistory.NO_COMMAND. To test equality with
     * apogee.app.CommandHistory.NO_COMMAND, use == or ===. Do not test equality
     * with json equals!*/
    getNextRedoDesc() {
