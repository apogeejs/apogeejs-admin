...
apogeeapp.app.EditWebComponentDisplay = function(component, options) {
...
apogeeapp.app.EditWebComponentDisplay.NO_EDIT_BACKGROUND_COLOR = "#f4f4f4";

apogeeapp.app.EditWebComponentDisplay.prototype.getDisplayFrame = function() {
    if(this.windowFrame) {
 ...
 * return {"x":x,"y":y}
 */
apogeeapp.app.EditWebComponentDisplay.prototype.getPreferredPosition = function() {
    if(this.options) {
...
apogeeapp.app.EditWebComponentDisplay.prototype.getPreferredState = function() {
...
apogeeapp.app.EditWebComponentDisplay.prototype.getComponent = function() {
    return this.component;
}

apogeeapp.app.EditWebComponentDisplay.prototype.getMember = function() {
    return this.member;
}

apogeeapp.app.EditWebComponentDisplay.prototype.getDataDisplay = function(viewMode,viewType) {
    return this.component.getDataDisplay(viewMode,viewType);
}

apogeeapp.app.EditWebComponentDisplay.prototype.deleteDisplay = function() {
...
apogeeapp.app.EditWebComponentDisplay.prototype.setBannerState = function(bannerState,bannerMessage) {
...
apogeeapp.app.EditWebComponentDisplay.prototype.updateViewModeElement = function(viewType) {
...
apogeeapp.app.EditWebComponentDisplay.prototype.getStateJson = function() {
    var json = {};
...
/** This gets the current window state, to reconstruct the view. */
apogeeapp.app.EditWebComponentDisplay.prototype.setStateJson = function(json) {
 ...
 * @private */
apogeeapp.app.EditWebComponentDisplay.prototype.loadWindowFrameEntry = function() {
 ...
 * @private */
apogeeapp.app.EditWebComponentDisplay.prototype.loadPlainFrameEntry = function() {
...
apogeeapp.app.EditWebComponentDisplay.prototype.createSelectTool = function() {
 ...
 * @protected */
apogeeapp.app.EditWebComponentDisplay.prototype.initContentUI = function() {
...
apogeeapp.app.EditWebComponentDisplay.prototype.getInitialViewType = function(viewTypes,defaultViewType) {
    if( (this.options) &&
...
/** This method populates the frame for this component. 
 * @protected */
apogeeapp.app.EditWebComponentDisplay.prototype.setViewType = function(viewType) {
...
apogeeapp.app.EditWebComponentDisplay.prototype.updateViewTypeSelect = function() {
...
apogeeapp.app.EditWebComponentDisplay.prototype.showDataDisplay = function(dataDisplay) {
    if(this.windowFrame) {
...
apogeeapp.app.EditWebComponentDisplay.prototype.removeDisplayElement = function(displayElement) {
    if(this.windowFrame) { 
 ...
 * @protected */
apogeeapp.app.EditWebComponentDisplay.prototype.startEditUI = function(onSave,onCancel) {
...
/** This method populates the frame for this component. 
 * @protected */
apogeeapp.app.EditWebComponentDisplay.prototype.endEditUI = function() {
    this.hideSaveBar();
...
apogeeapp.app.EditWebComponentDisplay.prototype.showSaveBar = function(onSave,onCancel) {
    if(!this.saveDiv) {
...
/** This method returns the base member for this component. */
apogeeapp.app.EditWebComponentDisplay.prototype.hideSaveBar = function() {
