...
haxapp.app.exportworkspace.getExportCallback = function(app) {
    ...
    var exportCallback = function() {
        ...
        var dialogLayout = haxapp.app.exportworkspace.getExportDialogLayout(folderNames);
        
        //create on submit callback
        var onSubmitFunction = function(result) {         
            var folder = folderMap[result.parentName];
        
            var workspaceText = haxapp.app.exportworkspace.getWorkspaceText(folder);
            if(!workspaceText) {
...
haxapp.app.exportworkspace.getWorkspaceText = function(folder) {
...
/** @private */
haxapp.app.exportworkspace.getExportDialogLayout = function(folderNames) {
